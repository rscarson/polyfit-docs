...
![Failure plot, data in red, fit in blue](recipes/using_asserts/assert_failed.png)
...
![Failure plot, 95% range for residuals in green/pink, residuals in red, fit over residuals in blue](recipes/using_asserts/assert_failed2.png)
...
![Failure plot, curve fit in blue, data in red](recipes/using_asserts/assert_failed3.png)
...
![Success plot, curve fit in blue, data in red](recipes/using_asserts/passed3.png)
